...
class __TwigTemplate_cbe3d795e3cca1743ff301842c811bb70f36c8de5fd9673a0206643d4c7e9300 extends Template
{
    ...
    <div class=\"row justify-content-md-center\">
        ...
        echo "\" class=\"btn btn-success \">Solicitudes</a>
                </div>
            </div>
        </div>
        <div class=\"col-6\">
            <div class=\"text-center\">
                <div class=\"center-block\">
                    <a href=\"asddd\" class=\"btn btn-success \">Otro botón que no hace nada</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class=\"row\">
        <a href=\"#\" class=\"btn  btn-primary\">Botón que hará algo en el futuro</a>
    </div>
    <br>
    <br>
    <br>
...
{% block body %}
    ...
    <div class=\"row justify-content-md-center\">
        <div class=\"col-6\">
            <div class=\"text-center\">
                <div class=\"center-block\">
                    <a href=\"{{ path('solicitudes') }}\" class=\"btn btn-success \">Solicitudes</a>
                </div>
            </div>
        </div>
        <div class=\"col-6\">
    ...
    <br>
    <br>
{% endblock %}", "dashboard/index.html.twig", "/var/www/html/intra/templates/dashboard/index.html.twig");
    }
}
