...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Form\\DispositivoType' => ['privates', 'App\\Form\\DispositivoType', 'getDispositivoTypeService', true],
            'App\\Form\\GrupoType' => ['privates', 'App\\Form\\GrupoType', 'getGrupoTypeService', true],
            'App\\Form\\MenuitemType' => ['privates', 'App\\Form\\MenuitemType', 'getMenuitemTypeService', true],
            'App\\Form\\NacionalidadType' => ['privates', 'App\\Form\\NacionalidadType', 'getNacionalidadTypeService', true],
            'App\\Form\\NuevaSolicitudType' => ['privates', 'App\\Form\\NuevaSolicitudType', 'getNuevaSolicitudTypeService', true],
            'App\\Form\\PersonaFisicaCollectionType' => ['privates', 'App\\Form\\PersonaFisicaCollectionType', 'getPersonaFisicaCollectionTypeService', true],
            'App\\Form\\PersonaJuridicaCollectionType' => ['privates', 'App\\Form\\PersonaJuridicaCollectionType', 'getPersonaJuridicaCollectionTypeService', true],
            'App\\Form\\PruebaType' => ['privates', 'App\\Form\\PruebaType', 'getPruebaTypeService', true],
            'App\\Form\\PruebagusType' => ['privates', 'App\\Form\\PruebagusType', 'getPruebagusTypeService', true],
            'App\\Form\\RepresentacionType' => ['privates', 'App\\Form\\RepresentacionType', 'getRepresentacionTypeService', true],
            'App\\Form\\RolKeycloakType' => ['privates', 'App\\Form\\RolKeycloakType', 'getRolKeycloakTypeService', true],
            'App\\Form\\SexoType' => ['privates', 'App\\Form\\SexoType', 'getSexoTypeService', true],
            ...
            'App\\Form\\DispositivoType' => '?',
            'App\\Form\\GrupoType' => '?',
            'App\\Form\\MenuitemType' => '?',
            'App\\Form\\NacionalidadType' => '?',
            'App\\Form\\NuevaSolicitudType' => '?',
            'App\\Form\\PersonaFisicaCollectionType' => '?',
            'App\\Form\\PersonaJuridicaCollectionType' => '?',
            'App\\Form\\PruebaType' => '?',
            'App\\Form\\PruebagusType' => '?',
            'App\\Form\\RepresentacionType' => '?',
            'App\\Form\\RolKeycloakType' => '?',
            'App\\Form\\SexoType' => '?',
