...
class getKnpu_Oauth2_Client_KeycloakService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['knpu.oauth2.client.keycloak'] = new \KnpU\OAuth2ClientBundle\Client\Provider\KeycloakClient((new \KnpU\OAuth2ClientBundle\DependencyInjection\ProviderFactory(($container->services['router'] ?? $container->getRouterService())))->createProvider('Stevenmaguire\\OAuth2\\Client\\Provider\\Keycloak', ['clientId' => $container->getEnv('KEYCLOAK_CLIENTID'), 'clientSecret' => $container->getEnv('KEYCLOAK_SECRET'), 'authServerUrl' => $container->getEnv('KEYCLOAK_APP_URL'), 'realm' => $container->getEnv('KEYCLOAK_REALM'), 'encryptionAlgorithm' => NULL, 'encryptionKeyPath' => NULL, 'encryptionKey' => NULL], 'oauth_check', [], []), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));
    }
}
