...
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (3150, 1, 3000, NULL, 'Invitacion a persona', 'Invitacion a persona', NULL, 'dashboard/nueva-solicitud', 1, 3150, 3150, '2', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (1000, 1, NULL, NULL, 'Home', 'Home', NULL, 'dashboard', 1, 1000, 1000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (10000, 2, NULL, NULL, 'Dashboard', 'Dashboard', NULL, 'dashboard', 1, 10000, 10000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (20000, 2, NULL, NULL, 'Orders', 'Orders', NULL, NULL, 1, 20000, 20000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (30000, 2, NULL, NULL, 'Products', 'Products', NULL, NULL, 1, 30000, 30000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (40000, 2, NULL, NULL, 'Customers', 'Customers', NULL, NULL, 1, 40000, 40000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (50000, 2, NULL, NULL, 'Reports', 'Reports', NULL, NULL, 1, 50000, 50000, '1', 1, NULL, NULL, 0);
INSERT INTO public.menuitem (id, menu_id, parent_id, rolecompany, name, nametree, icon, link, active, orderlist1, orderlist, type_id, availablesel, module, action, divider) VALUES (60000, 2, NULL, NULL, 'Integrations', 'Integrations', NULL, NULL, 1, 60000, 60000, '1', 1, NULL, NULL, 0);
