...
class MenuitemController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('menuitem_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('menuitem/new.html.twig', [
            'menuitem' => $menuitem,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Menuitem $menuitem): Response
    {
        ...
        return $this->renderForm('menuitem/edit.html.twig', [
            'menuitem' => $menuitem,
            'form' => $form,
        ]);
    }
